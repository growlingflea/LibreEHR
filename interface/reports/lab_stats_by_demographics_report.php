...
<head>
    ...
    <title><?php xl('Clinical Reports: Lab Results by Demographics','e'); ?></title>
...
<table cellpadding="0" cellspacing="0" border="0" class="display formtable" id="document_table">
    ...
    <tr>
        ...
        <th align="left"><input  id = 'column6_search' size="4"></th>
    </tr>

    <tr>
        <th><?php echo xla('Proc OrderID'); ?></th>
